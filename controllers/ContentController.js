...
router.post("/createnotes",upload.single("note_image"), (req, res)=>{
   // console.log("REQ:", req);
    ...
    console.log("ChecklistSchema Array: ", checklistJSON);
        ...
        var noteContent = {title: title, username: username, note: note, checklist: checklistJSON, image};
...
router.post("/editnotes", urlencoder, (req, res)=>{
